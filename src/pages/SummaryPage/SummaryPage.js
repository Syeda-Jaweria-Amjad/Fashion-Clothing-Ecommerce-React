            ...
            <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
                ...
                <div className="w-full px-3 min-[400px]:px-6">
                    ...
                    <div className="img-box max-lg:w-full">
                        <img src="https://pagedone.io/asset/uploads/1701167607.png" alt="Premium Watch image" className="aspect-square w-full lg:max-w-[140px] md:max-w-[180px] sm:max-w-[200px]" />
                    </div>
                    ...
                    <div className="img-box max-lg:w-full">
                        <img src="https://pagedone.io/asset/uploads/1701167621.png" alt="Diamond Watch image" className="aspect-square w-full lg:max-w-[140px] md:max-w-[180px] sm:max-w-[200px]" />
                    </div>
                    <div className="flex flex-row items-center w-full ">
                        <div className="grid grid-cols-1 lg:grid-cols-2 w-full">
                        <div className="flex items-center">
                            ...
                            <div className="flex items-center  ">
                                ...
                                <p className="font-medium text-base leading-7 text-black ">Qty: <span className="text-gray-500">1</span></p>
                            </div>
                            </div>
                        </div>
                        <div className="grid grid-cols-5">
                            ...
                            <div className="flex gap-3 lg:block">
                                ...
                                <p className="font-medium text-sm leading-6 py-0.5 px-3 whitespace-nowrap rounded-full lg:mt-3 bg-green-50 text-green-600">
                                Successfully Ordered</p>
                            </div>
                            </div>
                            <div className="col-span-5 lg:col-span-2 flex items-center max-lg:mt-3">
